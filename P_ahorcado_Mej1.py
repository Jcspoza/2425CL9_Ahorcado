...
# Nombre programa : P_ahorcado_Mej1.py
# Version : 1.1 mejora 1
...
def muestraPanel(letrasFall, letrasCorr, palabraSec):
    ...
    Version 1.1 : Mej1  reemplaza rayas con las letras correctas en su posicion
    """
...
while not JuegoAcabado:
    ...
    # Paso 2.2- El jugador propone una letra distinta a las ya dichas
